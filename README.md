...
<img src="https://github.com/danieljosesilva/heatrapy/blob/master/img/heatrapy.png" alt="Drawing" height="30"/> heatrapy v1.0.1
...
```python
>>> example = ht.single_object(293, materials=['Gd'], borders=[1,11], materials_order=[0],
...                            dx=0.05, dt=1., file_name='example.txt', boundaries=[300,0],
