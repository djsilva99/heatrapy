...
class calmatpro:
	...
	"""
	This class loads and gives physical properties of materials that are in folder 'materials'
	"""
	...
	def tadi(self,Temperature):
		...
		"""
		method gives the adiabatic temperature increase for a given temperature
		"""



		return pylab.interp(Temperature,self.xTadi,self.yTadi)
	...
	def tadd(self,Temperature):
		...
		"""
		method gives the adiabatic temperature decrease for a given temperature
		"""



		return pylab.interp(Temperature,self.xTadd,self.yTadd)
	...
	def cpa(self,Temperature):
		...
		"""
		method gives the active specific heat for a given temperature
		"""



		return pylab.interp(Temperature,self.xCpA,self.yCpA)
	...
	def cp0(self,Temperature):
		...
		"""
		method gives the specific heat for a given temperature
		"""



		return pylab.interp(Temperature,self.xCp0,self.yCp0)
	...
	def k0(self,Temperature):
		...
		"""
		method gives the thermal conductivity for a given temperature
		"""



		return pylab.interp(Temperature,self.xk0,self.yk0)
	...
	def ka(self,Temperature):
		...
		"""
		method gives the active thermal conductivity for a given temperature
		"""



		return pylab.interp(Temperature,self.xkA,self.ykA)
	...
	def rho0(self,Temperature):
		...
		return pylab.interp(Temperature,self.xrho0,self.yrho0)
	...
	def rhoa(self,Temperature):
		...
		return pylab.interp(Temperature,self.xrhoA,self.yrhoA)