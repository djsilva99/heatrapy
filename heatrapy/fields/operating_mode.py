...
def operating_mode(mode, restingTimeCold, restingTimeHot,
                   field_steps, freq, j):
    ...
    if mode == 'constant_right':
        time_interval = ((1 - restingTimeHot - restingTimeCold) * period / 2.)
    ...
    if mode == 'accelerated_right':
        delta_t = ((1 / (2 * (1. / (1. - restingTimeHot - restingTimeCold)) *
