...
class magcalsys_fluidAMR_1D:
    ...
    def __init__(self, fileName, ambTemperature=293, fluid_length=100,
                 ...
                 restingTimeHot=0.1, restingTimeCold=0.1,
                 applied_static_field_time_ratio=(0.,0.),removed_static_field_time_ratio=(0.,0.),
